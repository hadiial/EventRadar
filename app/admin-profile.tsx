 ...
 * Displays the admin's personal information, settings, and a logout button.
 */
export default function AdminProfileScreen() {
  ...
  /**
   * Fetch Admin Profile data from Firebase Realtime Database
   */
  useEffect(() => {
  ...
  /**
   * handleLogout
   * Signs the user out of Firebase and redirects to the Login screen.
   */
  const handleLogout = () => {
    Alert.alert(
      'Konfirmasi Logout',
      ...
      [
        ...
        { 
          ...
          onPress: async () => {
            try {
              await signOut(auth);
              // Router replace prevents going back to this screen
              router.replace('/login');
            } catch (error) {
  ...
  /**
   * Placeholder handler for unimplemented settings features
   */
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.profileImageContainer}>
          {/* Replace uri with your actual image source if available */}
          <Image 
            source={{ uri: 'https://via.placeholder.com/150/2F4454/FFFFFF?text=Admin' }} 
        ...
        <View style={styles.settingsSection}>
          ...
          <View style={styles.settingsCard}>
            ...
            <TouchableOpacity style={styles.settingRow} onPress={() => handleFeatureClick('Hubungi Kami')}>
...
const styles = StyleSheet.create({
  ...
  scrollContent: {
    ...
    paddingTop: 30,
    paddingBottom: 110, // Ensure space for BottomNav
  },
  ...
  editImageBtn: {
    ...
    alignItems: 'center',
    borderWidth: 2,
    borderColor: '#E8F5CC', // Creates a cutout effect
  },
  // FORM FIELDS STYLES
  formSection: {
    marginBottom: 25,
  ...
  settingsCard: {
    backgroundColor: '#FFFFFF',
    borderRadius: 15,
    overflow: 'hidden', // Ensures border radius applies to child rows
  },
  settingRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
