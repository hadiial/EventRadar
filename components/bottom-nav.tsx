...
/**
 * BottomNav Component
 * A reusable bottom navigation bar for user screens.
  ...
  return (
    <View style={styles.bottomNavContainer}>
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity 
          style={[styles.navIcon, pathname === '/jadwal' && styles.activeNavIcon]} 
        ...
        {/* BOOKMARKS BUTTON */}
        <TouchableOpacity 
          style={[styles.navIcon, pathname === '/bookmarks-page' && styles.activeNavIcon]} 
        ...
        {/* CREATE EVENT BUTTON / PLUS ICON */}
        <TouchableOpacity 
          style={[styles.navIcon, pathname === '/event-form' && styles.activeNavIcon]} 
        ...
        {/* USER PROFILE BUTTON */}
        <TouchableOpacity 
          style={[styles.navIcon, pathname === '/user-profile' && styles.activeNavIcon]} 
